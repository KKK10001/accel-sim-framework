...
# 32.272 (+4.534%)
# ./regress.sh l1d_with_victim_cache_ent_4 --config-file ./perf_study/configs/l1d_with_victim_cache.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_victim_cache_ent_4
# 32.320 (+4.691%)
# ./regress.sh l1d_with_victim_cache_ent_8 --config-file ./perf_study/configs/l1d_with_victim_cache.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_victim_cache_ent_8
# done
...
# 4/3 31.361 (+1.399%)
# ./regress.sh l1d_byp_with_vb_ent_4096 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_4096

# ./regress.sh l1d_include_byp_fill_extra_mf_fields_T_1_F_T_20_5_3_lrr --config-file ./perf_study/configs/l1d_no_vc_byp_no_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_include_byp_fill_extra_mf_fields_T_1_F_T_20_5_3_lrr

# 1. LRR
# done
# ./regress.sh reg_l1d_base_lrr --config-file ./perf_study/configs/base_no_mshr_lrr.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_base_lrr
# done
# ./regress.sh reg_l1d_dyn_byp_total_evict_aware_lrr --config-file ./perf_study/configs/l1d_dyn_byp_total_evict_aware_lrr.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_total_evict_aware_lrr
# done
# ./regress.sh reg_l1d_dyn_byp_total_evict_unaware_lrr --config-file ./perf_study/configs/l1d_dyn_byp_total_evict_unaware_lrr.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_total_evict_unaware_lrr
# 2. GTO
# done
# ./regress.sh reg_l1d_base_gto --config-file ./perf_study/configs/base_no_mshr_gto.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_base_gto
# done
# ./regress.sh reg_l1d_dyn_byp_total_evict_aware_gto --config-file ./perf_study/configs/l1d_dyn_byp_total_evict_aware_gto.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_total_evict_aware_gto
# done
# ./regress.sh reg_l1d_dyn_byp_total_evict_unaware_gto --config-file ./perf_study/configs/l1d_dyn_byp_total_evict_unaware_gto.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_total_evict_unaware_gto
...
# 124.142 (+3.054%)	
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_T_1_F_T_20_5_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_byp_no_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_T_1_F_T_20_5_3_lrr_srad_v2
# 120.251 (-0.176%)	
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_include_byp_fill_extra_mf_fields_T_1_F_T_20_5_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_byp_no_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_include_byp_fill_extra_mf_fields_T_1_F_T_20_5_3_lrr_srad_v2
# 119.236 (-1.019%)	
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_incoming_req_T_1_F_T_20_5_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_byp_no_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_incoming_req_T_1_F_T_20_5_3_lrr_srad_v2
# 121.218 (+0.627%)	
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_incoming_req_T_1_F_T_20_10_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_byp_no_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_incoming_req_T_1_F_T_20_10_3_lrr_srad_v2

# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_vb_T_0_F_T_20_3_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_vb_T_0_F_T_20_3_3_lrr_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_vb_ent_128_T_0_F_T_20_3_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_vb_ent_128_T_0_F_T_20_3_3_lrr_srad_v2

# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_vb_ent_1024_T_0_F_T_20_3_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_vb_ent_1024_T_0_F_T_20_3_3_lrr_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_vb_ent_4096_T_0_F_T_20_3_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_vb_ent_4096_T_0_F_T_20_3_3_lrr_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_vb_ent_4096_T_0_F_T_20_2_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_vb_ent_4096_T_0_F_T_20_2_3_lrr_srad_v2

# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_vb_ent_1024_T_0_F_T_20_2_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_vb_ent_1024_T_0_F_T_20_2_3_lrr_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_vb_ent_1024_T_0_F_T_20_1_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_vb_ent_1024_T_0_F_T_20_1_3_lrr_srad_v2

# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_incoming_req_T_1_F_T_40_10_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_byp_no_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_incoming_req_T_1_F_T_40_10_3_lrr_srad_v2

# 120.237 (-0.188%)	
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_incoming_req_T_1_F_T_20_15_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_byp_no_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_incoming_req_T_1_F_T_20_15_3_lrr_srad_v2
# 120.225 (-0.198%)	
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_incoming_req_T_1_F_T_20_20_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_no_vc_byp_no_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_incoming_req_T_1_F_T_20_20_3_lrr_srad_v2

# 4/3
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_insert_byp_item_into_vb_ent_64_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_insert_byp_item_into_vb_ent_64_srad_v2

# 124.142 (+3.054%) with <bypass_mode>
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_without_vb_with_bypassmode_cfg_srad_v2 --config-file ./perf_study/configs/l1d_byp_without_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_without_vb_with_bypassmode_cfg_srad_v2

# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_srad_v2

# 130.253 (+8.127%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_8192_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_8192_srad_v2
# 130.253 (+8.127%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_4096_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_4096_srad_v2
# 124.327 (+3.207%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_2048_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_2048_srad_v2
# 123.250 (+2.313%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_1024_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_1024_srad_v2
# 117.819 (-2.195%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_512_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_512_srad_v2
# 119.332 (-0.939%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_256_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_256_srad_v2
# 118.164 (-1.909%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_128_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_128_srad_v2
# 120.761 (+0.248%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_32_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_32_srad_v2

# 121.568 (+0.917%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_16_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_16_srad_v2
# 122.612 (+1.784%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_with_vb_ent_8_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_with_vb_ent_8_srad_v2

# Use previous cfg. file no <bypass_mode>
# 124.142 (+3.054%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_without_vb_srad_v2 --config-file ./perf_study/configs/l1d_dyn_byp_lrr.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_without_vb_srad_v2
...
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_byp_T_F_T_20_5_3_lrr_vc_ent_8_srad_v2 --config-file ./perf_study/configs/l1d_dyn_byp_lrr_victim_cache.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_byp_T_F_T_20_5_3_lrr_vc_ent_8_srad_v2
...
# 187.614 (+55.744%)
# 122.612 (+1.784%) (Fix)
# Try recover allowing modified lines being inserted into VC again.
...
# 118.937 (-1.267%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_with_victim_cache_ent_12_srad_v2 --config-file ./perf_study/configs/l1d_with_victim_cache.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_victim_cache_ent_12_srad_v2
...
# 185.563 (+54.041%)
# 120.761 (+0.248%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_with_victim_cache_ent_64_srad_v2 --config-file ./perf_study/configs/l1d_with_victim_cache.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_victim_cache_ent_64_srad_v2
...
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_with_vc_ent_64_byp_T_F_T_20_5_3_lrr_srad_v2 --config-file ./perf_study/configs/l1d_byp_with_vc.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_vc_ent_64_byp_T_F_T_20_5_3_lrr_srad_v2

# 4/3 afternoon
# 120.364 (-0.082%)
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_with_vc_ent_8_no_byp_srad_v2 --config-file ./perf_study/configs/l1d_with_vc_no_byp.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_vc_ent_8_no_byp_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_with_vc_ent_16_no_byp_srad_v2 --config-file ./perf_study/configs/l1d_with_vc_no_byp.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_vc_ent_16_no_byp_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_with_vc_ent_64_no_byp_srad_v2 --config-file ./perf_study/configs/l1d_with_vc_no_byp.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_vc_ent_64_no_byp_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_with_vc_ent_128_no_byp_srad_v2 --config-file ./perf_study/configs/l1d_with_vc_no_byp.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_vc_ent_128_no_byp_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_with_vc_ent_256_no_byp_srad_v2 --config-file ./perf_study/configs/l1d_with_vc_no_byp.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_vc_ent_256_no_byp_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft l1d_with_vc_ent_512_no_byp_srad_v2 --config-file ./perf_study/configs/l1d_with_vc_no_byp.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_vc_ent_512_no_byp_srad_v2
...
# ./regress.sh single srad_v2-rodinia-2.0-ft reg_l1d_dyn_byp_total_evict_aware_gto_srad_v2 --config-file ./perf_study/configs/l1d_dyn_byp_total_evict_aware_gto.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_total_evict_aware_gto_srad_v2
# ./regress.sh single srad_v2-rodinia-2.0-ft reg_l1d_dyn_byp_total_evict_unaware_gto_srad_v2 --config-file ./perf_study/configs/l1d_dyn_byp_total_evict_unaware_gto.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_total_evict_unaware_gto_srad_v2
...
# ./regress.sh single nw-rodinia-2.0-ft reg_base_no_mshr_nw --config-file ./perf_study/configs/base_no_mshr_lrr.config
# ./util/job_launching/monitor_func_test.py -v -N reg_base_no_mshr_nw
# 4.235 (+0.000%)
# ./regress.sh single nw-rodinia-2.0-ft l1d_with_vc_ent_64_nw --config-file ./perf_study/configs/l1d_with_victim_cache.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_vc_ent_64_nw

# pathfinder 
# ./regress.sh single pathfinder-rodinia-2.0-ft l1d_baseline_pathfinder --config-file ./perf_study/configs/base_no_mshr_lrr.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_baseline_pathfinder
# 31.451 (+0.000%)
# ./regress.sh single pathfinder-rodinia-2.0-ft l1d_with_vc_ent_64_pathfinder --config-file ./perf_study/configs/l1d_with_victim_cache.config
...
# ./regress.sh single hotspot-rodinia-2.0-ft l1d_with_vc_ent_64_byp_T_F_T_20_5_3_lrr_hotspot --config-file ./perf_study/configs/l1d_byp_with_vc.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_with_vc_ent_64_byp_T_F_T_20_5_3_lrr_hotspot

# ./regress.sh single hotspot-rodinia-2.0-ft l1d_insert_byp_item_into_vb_ent_64_hotspot --config-file ./perf_study/configs/l1d_byp_with_vb.config
# ./util/job_launching/monitor_func_test.py -v -N l1d_insert_byp_item_into_vb_ent_64_hotspot

## Eval of max_bypasses
# ./regress.sh single hotspot-rodinia-2.0-ft reg_l1d_dyn_byp_infinite_bypasses_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_tune_max_bypasses.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_infinite_bypasses_hotspot
# ./regress.sh single hotspot-rodinia-2.0-ft reg_l1d_dyn_byp_infinite_bypasses_II_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_tune_max_bypasses.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_infinite_bypasses_II_hotspot
# ./regress.sh single hotspot-rodinia-2.0-ft reg_l1d_dyn_byp_max_bypasses_45_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_tune_max_bypasses.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_max_bypasses_45_hotspot
# ./regress.sh single hotspot-rodinia-2.0-ft reg_l1d_dyn_byp_max_bypasses_40_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_tune_max_bypasses.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_max_bypasses_40_hotspot
# ./regress.sh single hotspot-rodinia-2.0-ft reg_l1d_dyn_byp_max_bypasses_35_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_tune_max_bypasses.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_max_bypasses_35_hotspot
# ./regress.sh single hotspot-rodinia-2.0-ft reg_l1d_dyn_byp_max_bypasses_30_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_tune_max_bypasses.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_max_bypasses_30_hotspot
# ./regress.sh single hotspot-rodinia-2.0-ft reg_l1d_dyn_byp_max_bypasses_25_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_tune_max_bypasses.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_max_bypasses_25_hotspot
# ./regress.sh single hotspot-rodinia-2.0-ft reg_l1d_dyn_byp_max_bypasses_20_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_tune_max_bypasses.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_dyn_byp_max_bypasses_20_hotspot

# ./regress.sh single hotspot-rodinia-2.0-ft reg_l1d_base_lrr_hotspot --config-file ./perf_study/configs/base_no_mshr_lrr.config
# ./util/job_launching/monitor_func_test.py -v -N reg_l1d_base_lrr_hotspot
# ./regress.sh single hotspot-rodinia-2.0-ft both_vic_byp_key_use_blkaddr_T_F_T_80_3_3_lrr_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_lrr.config
# ./util/job_launching/monitor_func_test.py -v -N both_vic_byp_key_use_blkaddr_T_F_T_80_3_3_lrr_hotspot
# ./regress.sh single hotspot-rodinia-2.0-ft both_vic_byp_key_use_blkaddr_T_F_T_40_3_3_lrr_hotspot --config-file ./perf_study/configs/l1d_dyn_byp_lrr.config
...
# ./util/job_launching/monitor_func_test.py -v -N both_vic_byp_key_use_blkaddr_T_T_F_20_1_1_lrr_hotspot
