...
python plot-benchmark-fail-stats-per-item-plot.py \
    ...
    --geomean-summary \
    --geomean-target mshr-entries-32 \
...
python plot-benchmark-fail-stats-per-item-plot.py \
    ...
    --geomean-summary \
    --geomean-target fuck-perf-study-mshr-max-merge-32 \
    --geomean-metrics ipc global_acc_r global_acc_w
...
python plot-benchmark-fail-stats-per-item-plot.py \
    ...
    --geomean-summary \
    --geomean-target fuck-perf-study-miss-q-entries-32 \
    --geomean-metrics ipc global_acc_r global_acc_w

# gather all
python plot-benchmark-fail-stats-per-item-plot.py \
    --sim-root $ACCELSIM_ROOT/../sim_run_12.1 \
    --variants regress-default-cfg-11-25-eve fuck-perf-study-miss-q-entries-32 fuck-perf-study-mshr-max-merge-32 perf-study-miss-q-ent-32-and-mshr-max-merge-32 \
    --geomean-summary \
    --geomean-target regress-default-cfg-11-25-eve fuck-perf-study-miss-q-entries-32 fuck-perf-study-mshr-max-merge-32 perf-study-miss-q-ent-32-and-mshr-max-merge-32 \
    --geomean-metrics ipc global_acc_r global_acc_w
...
python plot-benchmark-fail-stats-per-item-plot.py \
    --sim-root $ACCELSIM_ROOT/../sim_run_12.1 \
    --variants regress-default-cfg-11-25-eve \
        perf-study-miss-q-ent-32-and-mshr-max-merge-16 \
        perf-study-miss-q-ent-32-and-mshr-max-merge-32 \
        perf-study-miss-q-ent-64-and-mshr-max-merge-32 \
        perf-study-miss-q-ent-128-and-mshr-max-merge-32 \
        perf-study-miss-q-ent-256-and-mshr-max-merge-32 \
...
def norm_variant(tag:str)->str:
    ...
    if tag in ('default-config','default-cfg'): return 'base-config'
    if tag.startswith('default-config-') or tag.startswith('default-cfg-'): return 'base-config'
    return tag
