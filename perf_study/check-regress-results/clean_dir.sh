...
# regress_tag=reg_l1d_dyn_byp_total_evict_aware_upb_3_bypset_20_lrr_hotspot
# regress_tag=reg_l1d_dyn_byp_total_evict_aware_upb_3_bypset_35_lrr_hotspot
# regress_tag=reg_l1d_dyn_byp_max_bypasses_45_hotspot
# regress_tag=reg_l1d_dyn_byp_max_bypasses_40_hotspot
regress_tag=reg_l1d_dyn_byp_max_bypasses_20_hotspot
# regress_tag=reg_l1d_dyn_byp_total_evict_aware_upb_3_bypset_30_lrr_hotspot
...
# regress_tag=reg_l1d_dyn_byp_total_evict_aware_upb_2_lrr_hotspot
# regress_tag=reg_l1d_dyn_byp_total_evict_unaware_lrr_hotspot
# regress_tag=reg_l1d_dyn_byp_total_evict_aware_upb_3_gto_hotspot
# regress_tag=reg_l1d_dyn_byp_total_evict_aware_upb_3_lrr_streamcluster
# regress_tag=reg_l1d_dyn_byp_total_evict_aware_lrr_srad_v2
# regress_tag=reg_l1d_dyn_byp_total_evict_aware_upb_3_lrr_srad_v2
# regress_tag=reg_l1d_base_lrr_hotspot
