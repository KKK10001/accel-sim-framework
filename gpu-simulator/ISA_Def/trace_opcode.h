...
inline const char* sass_op_type_str(enum TraceInstrOpcode type) {
  static const char *static_sass_op_type_str[] = {
    "OP_FADD",
    "OP_FADD32I",
    "OP_FCHK",
    "OP_FFMA32I",
  ...
  assert(sizeof(static_sass_op_type_str) / sizeof(const char *) ==
    SASS_NUM_OPCODES);
  assert(type < SASS_NUM_OPCODES);
  return static_sass_op_type_str[type];
}
